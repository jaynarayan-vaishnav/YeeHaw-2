            ...
            <div className="flex items-center justify-between h-[10vh] gap-10">
                <div className="w-full justify-between flex items-center">
                    <a className="flex flex-shrink-0 gap-1 hover:scale-105 duration-300" href="/">
                        <img className="h-6 w-6 saturate-200" src="/revolver.png" alt="site logo" />
                ...
                <button className="flex font-cormorant text-md text-white font-bold bg-red-500 px-4 py-2 rounded-lg hover:bg-amber-500 duration-300">
                    LOGIN
                </button>
            </div>
        </div>
